...
def train(args, model, enc=False):
    ...
    if enc:
        weight = torch.tensor([1.346996, 1.735906, 1.441419, 2.275653, 2.203878, 2.121798, 2.558281, 2.317742, 
                               1.517654, 2.135958, 1.834738, 2.123857, 2.665959, 1.703171, 2.496629, 2.528314, 
                               2.530832, 2.743244, 2.389064, 10.0])
    else:
        weight = torch.tensor([1.023646, 1.135421, 1.037944, 1.853612, 1.696299, 1.542178, 2.658289, 1.955491, 
                               1.053963, 1.566814, 1.198913, 1.545711, 3.025306, 1.11874, 2.460806, 2.56101, 
                               2.569092, 3.302527, 2.143622, 10.0])
